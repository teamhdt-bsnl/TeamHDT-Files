...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton(text="⚡ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://t.me/Team_HDT_Links/21')
        ]
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⚡ CHANNEL ⚡', url='https://t.me/TEAM_HDT'),
            InlineKeyboardButton('⚡ LINKS ⚡', url='https://t.me/TEAM_HDT_LINKS')
        ], [
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"Rᴇǫᴜᴇsᴛᴇᴅ ᴍᴏᴠɪᴇ ɴᴀᴍᴇ : <code>{search}</code>\n\nIf the requested movie not displayed please 👇\n\n<a href=https://t.me/+o01XAzZXrvVjZTBh><b>CHECK HERE</b></a>"
